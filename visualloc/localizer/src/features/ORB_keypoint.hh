...
#ifndef ORB_KEYPOINT_HH
#define ORB_KEYPOINT_HH

/**
 *    Simple class defining a ORB-keypoint, excluding its descriptor.
**/ 
...
class ORB_keypoint
{
  public:
	...
	ORB_keypoint( float x_, float y_, float scale_, float orientation_ )
	{
	  x = x_;
	  y = y_;
	  scale = scale_;
